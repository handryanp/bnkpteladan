...
<head>
    <meta charset="utf-8">
    <title>View Pembabtisan Anak</title>
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $query = "SELECT * FROM `babtisanak_verifikasi` WHERE `id` = $id";
                        ...
                        <ul class="list-group-numbered mb-2">
                            ...
                            <ol type="a">
                                ...
                                <li class="mb-2">
                                    <div style="display: flex; justify-content: space-between">
                                        <span>US</span>
                                        <input style="width: 100px;" type="number" class="form-control" placeholder="Rp." name="uang_sumbangan" value="<?= htmlspecialchars($r['uang_sumbangan']); ?>" readonly>
                                    </div>
                                </li>
                                <li class="mb-2">
                                    <div style="display: flex; justify-content: space-between">
                                        <span>Foto Tambahan (12.000/Lembar)</span>
                                        <input style="width: 100px;" type="number" class="form-control" placeholder="Rp." name="foto_tambahan" value="<?= htmlspecialchars($r['foto_tambahan']); ?>" readonly>
                                    </div>
                                </li>
                            </ol>
                        </ul>
