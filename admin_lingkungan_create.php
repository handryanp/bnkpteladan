...
<head>
    <meta charset="utf-8">
    <title>Setting Lingkungan</title>
...
<div class="sidebar sidebar-bunker">
    ...
    <section style="position: relative; bottom: 140px; background-color: white;" class="home-section">
      ...
      <div class="d-flex flex-column p-4 border">
        <h2 class="text-center mb-3 mt-3">Tambah Lingkungan</h2>
        <?php
            ...
            <?php endif; ?>
        <form method="post" action="admin_lingkungan_simpan.php" enctype="multipart/form-data">
            <div class="col-md-6">
              <div class="form-group mb-3">
                <label for="nama">Nama Lingkungan</label>
                <input type="text" class="form-control" placeholder="Nama Lingkungan" name="lingkungan">
              </div>
            </div>
