  ...
  <div class="sidebar sidebar-bunker">
    ...
    <section style="position: relative; bottom: 140px; background-color: white;" class="home-section">
      ...
      <div class="container-fluid py-6 px-5">
        <div>
          <a type="submit" href="verifikasi_pendataan_jemaat.php" name="btn" class="btn btn-primary btn-block" style="width: 450px; height: 40px; border-radius: 10px; position: relative; left: 400px; top: 150px;">Verifikasi Pendataan Jemaat</a>
        </div><br>
        <div>
          <a type="submit" href="datajemaat_view.php" name="btn" class="btn btn-primary btn-block" style="width: 450px; height: 40px; border-radius: 10px; position: relative; left: 400px; top: 150px;">Data Jemaat</a>
        </div>
      </div>
    </section>
