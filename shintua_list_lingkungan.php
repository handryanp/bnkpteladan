    ...
    <div class="container-fluid py-6 px-5">
        <div class="row g-5">
            <div class="col-12 col-md-8">
                <h2 class="m-0 text-secondary" style="position: relative; bottom: 20px;">List Lingkungan</h2>
                <input style="position: relative; width: 1440px" type="text" id="searchInput" class="form-control" placeholder="Masukkan kata kunci pencarian..." onkeyup="searchTable()">
            </div>
                    ...
                    <table class="table display table-bordered table-striped table-hover basic dataTable no-footer" id="dataTable" role="grid" aria-describedby="DataTables_Table_0_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 125.133px;" aria-label="Start date: activate to sort column ascending">Lingkungan</th>
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>";
                                    echo "<a href='shintua_view.php?id=" . $row["id"] . "' title='Lihat'><i class='far fa-eye' style='font-size: 20px; color: green; margin-right: 10px;'></i></a>";
                                    echo "<a href='#" . $row["id"] . "' title='Edit'><i class='fas fa-pencil-alt' style='font-size: 20px; color: #2772ab; margin-right: 10px;'></i></a>";
                                    echo "<a href='shintua_delete.php?id=" . $row["id"] . "' onclick='return confirm(\"Apakah Anda yakin ingin Hapus Data?\");' title='Hapus'><i class='fas fa-trash' style='font-size: 20px; color: red;'></i></a>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
