...
<div class="sidebar sidebar-bunker">
    ...
    <section style="position: relative; bottom: 140px; background-color: white;" class="home-section">
      ...
      <div class="container-fluid py-6 px-5">
        <div class="row g-5">
                <h2 class="m-0 text-secondary" style="position: relative; bottom: 20px;">Detail Warta Jemaat 24 Juli 2024</h2>
                <div class="container">
                            ...
                            <div class="form-group mb-3">
                              ...
                              <div class="row">
                                <div class="col-6 col-sm-3">
                                  <input type="radio" id="warta" name="jenis" value="warta" checked disabled>
                                  <label for="warta">Warta Jemaat</label><br>
                                </div>
                                <div class="col-6 col-sm-3">
                                  <input type="radio" id="kegiatna" name="jenis" value="kegiatan" disabled>
                          ...
                          <div class="col-md-6">
                            <div class="form-group mb-3">
                              ...
                              style="border-radius: 10px;"
                                type="text"
                                class="form-control"
                                placeholder="Warta Jemaat 24 Juli 2024" readonly
                              />
                            </div>
                          </div>
                          <div class="form-group mb-3">
