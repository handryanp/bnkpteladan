...
<body>
    ...
    <section style="position: relative; bottom: 140px; background-color: white;" class="home-section">
        ...
        <div class="container-fluid py-6 px-5">
            <div class="row g-5">
                <h2 class="m-0 text-secondary" style="position: relative;">Verifikasi Warta Jemaat & Kegiatan</h2>
                <?php
                                ...
                                <table class="table display table-bordered table-striped table-hover basic dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 132.133px;" aria-label="Position: activate to sort column ascending">Jenis Berita</th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 220px;" aria-label="Start date: activate to sort column ascending">Judul</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM `bnkpteladan`.`berita`";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>";
                                                echo "<a href='warta_verifikasi_view.php?id=" . $row["warta_id"] . "' title='Lihat'><i class='far fa-eye' style='font-size: 20px; color: #2772ab; margin-right: 10px;'></i></a>";
                                                echo "<a href='warta_verifikasi_simpan.php?id=" . $row["warta_id"] . "' onclick='return confirm(\"Apakah Anda yakin ingin Verifikasi?\");' title='Verifikasi'><i class='fas fa-check' style='font-size: 20px; color: green;'></i></a>";
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                        } else {
                                            echo "<tr><td colspan='5'>Tidak ada berita yang mau diverifikasi nih!</td></tr>";
                                        }
                                        $conn->close();
                                        ?>
                                    </tbody>
