  ...
  <section style="position: relative; bottom: 140px; background-color: white;" class="home-section">
    ...
    <div class="container">
      <div class="d-flex flex-column p-4 border">
        <h2 class="text-center mb-3 mt-3">Tambah SNK Profile</h2>
        <?php
        ...
        <form method="post" action="admin_shintua_simpan.php" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Nama Panggilan" name="nickname">
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group mb-3">
                <label for="TempatLahir"> Tempat Lahir</label>
                <input type="text" name="tmptlahir" class="form-control" placeholder="Tempat Lahir">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="TanggalLahir"> Tanggal Lahir</label>
                <input type="date" name="tnggllahir" class="form-control" placeholder="Tanggal Lahir" value="<?php echo date('y-m-d'); ?>">
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
              ...
              <input type="number" class="form-control" placeholder="Nomor SK" name="nomorsk">
            </div>
            <div class="form-group mb-3">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <input type="number" class="form-control" placeholder="Lingkungan" name="lingkungan">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group mb-3">
                <label for="sektor">Sektor</label>
                <input type="text" class="form-control" placeholder="Sektor" name="sektor">
              </div>
            </div>
            <div class="form-group mb-3">
              <label for="nomortelp">Nomor Telepon</label>
              <input type="number" class="form-control" placeholder="Masukkan No Telepon" name="nomortelp">
            </div>
          </div>
