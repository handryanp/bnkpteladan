...
<body>
  ...
  if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $query = "SELECT * FROM `bnkpteladan`.`berita` WHERE `warta_id` = $id";
    ...
    <section style="position: relative; bottom: 140px; background-color: white;" class="home-section">
      ...
      <div class="container">
        <div class="d-flex flex-column p-4 border">
          ...
          <?php endif; ?>
          <form method="post" action="warta_verifikasi_simpan.php" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group mb-3">
                  ...
                  <div class="row">
                    <div class="col-6 col-sm-3">
                      <input class="form-control" type="text" placeholder="Jenis" name="jenis" value="<?= htmlspecialchars($r['jenis']); ?>" readonly>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group mb-3">
                  ...
                  <input style="border-radius: 10px;" type="text" class="form-control" placeholder="-" name="judul" value="<?= htmlspecialchars($r['judul']); ?>" readonly>
                </div>
              </div>
              <div class="form-group mb-3">
                <label for="tanggal">Tanggal</label>
                <input style="border-radius: 10px;" class="form-control" type="date" id="example-date-input" name="tanggal" value="<?= htmlspecialchars($r['tanggal']); ?>" readonly>
              </div>
            </div>
            <div class="form-group mb-3">
              <label for="deskripsi">Deskripsi</label>
              <textarea style="border-radius: 10px;" type="text" class="form-control" placeholder="Masukkan Deskripsi" rows="5" name="deskripsi" readonly><?= htmlspecialchars($r['deskripsi']); ?></textarea>
            </div>
            <div class="form-group mb-3">
              <label for="gambar">File Terupload</label>
              <div class="col-sm-9">
