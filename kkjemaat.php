        ...
        <div class="container-fluid py-6 px-5">
            <div class="row g-5">
                <div class="col-12 col-md-8">
                    <h2 class="m-0 text-secondary" style="position: relative; bottom: 20px;">List KK Jemaat</h2>
                </div>
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row">
                                <label><input style="height: 50px;" type="search" class="form-control form-control-sm" placeholder="Cari berdasarkan no kk atau nama kepala keluarga" aria-controls="DataTables_Table_0"></label>
                            </div>
                            </br>
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>";
                                            echo "<a href='kk_jemaat_verifikasi_view.php?id=" . $row["id"] . "' title='Lihat'><i class='fa fa-eye' style='font-size: 20px; color: #2772ab; margin-right: 10px;'></i></a>";
