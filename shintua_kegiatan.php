...
$warta_sql = "SELECT * FROM `berita_verifikasi` WHERE jenis='Kegiatan' ORDER BY tanggal DESC";
                        ...
                        <div class="blog-item">
                            ...
                            <div class="bg-secondary d-flex">
                                ...
                                <div class="d-flex flex-column justify-content-center py-3 px-4">
                                    <a class="h4" href="shintua_rincian_kegiatan.php?warta_id=' . $row["warta_id"] . '">' . $row["judul"] . '</a>
                                </div>
                            </div>
                        </div>
                    </div>';
