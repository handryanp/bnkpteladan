...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div id="wartajemaat" class="container-fluid py-6 px-5">
                ...
                <div class="col-lg-4">
                    <div class="team-item position-relative overflow-hidden">
                        ...
                        <div class="team-text w-100 position-absolute top-50 text-center bg-primary p-4">
                            ...
                            <a href="shintua_rincian_warta.php?warta_id=' . $row["warta_id"] . '" class="btn btn-primary btn-block">Read More</a>
                        </div>
                    </div>
                </div>';
                    }
            ...
            <div>
                <a href="shintua_warta.php" class="btn btn-primary btn-block align-items-center" style="display: inline-block; width: 1420px; height: 40px; position: relative; top: 30px;">Read More</a>
            </div>
        </div>
        <div id="kegiatan" class="container-fluid px-5">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item bg-secondary text-center px-5">
                        ...
                        <a href="shintua_rincian_kegiatan.php?warta_id=' . $row["warta_id"] . '" class="mb-2 btn">Read More <i class="hvr-buzz-out fas fa-angle-right"></i></a>
                    </div>
                </div>';
                    }
                } else {
            ...
            <div>
                <a href="shintua_kegiatan.php" class="btn btn-primary btn-block align-items-center" style="display: inline-block; width: 1420px; height: 40px; position: relative; top: 30px;">Read More</a>
            </div>
        </div>
        </br>
