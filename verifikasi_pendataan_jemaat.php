...
<div class="sidebar sidebar-bunker">
    ...
    <div class="row g-5">
        ...
        <input style="position: relative; left: 15px; width: 1180px" type="text" id="searchInput" class="form-control" placeholder="Masukkan kata kunci pencarian..." onkeyup="searchTable()">    
        <div class="card-body">
        <?php
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo "<td>";
                                                                echo "<a href='kk_jemaat_view.php?id=" . $row["id"] . "' title='Lihat'><i class='fa fa-eye' style='font-size: 20px; color: #2772ab; margin-right: 10px;'></i></a>";
                                                                echo "<a href='kk_jemaat_verifikasi.php?id=" . $row["id"] . "' onclick='return confirm(\"Apakah Anda yakin ingin Verifikasi?\");' title='Verifikasi'><i class='hvr-buzz-out fas fa-check' style='font-size: 20px; color: green; margin-right: 10px;'></i></a>";
                                                                echo "<a href='kk_jemaat_delete.php?id=" . $row["id"] . "' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\");' title='Hapus'><i class='fa fa-trash' style='font-size: 20px; color: red;'></i></a>";
                                                                echo "</td>";
                                                                echo "</tr>";
                                                            }
                                                        }
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo "<td>" . $row["nomorkk"] . "</td>";
                                                                echo "<td>";
                                                                echo "<a href='pembabtisananak_view.php?id=" . $row["id"] . "' title='Lihat'><i class='fa fa-eye' style='font-size: 20px; color: #2772ab; margin-right: 10px;'></i></a>";
                                                                echo "<a href='pembabtisananak_verifikasi.php?id=" . $row["id"] . "' onclick='return confirm(\"Apakah Anda yakin ingin Verifikasi?\");' title='Verifikasi'><i class='hvr-buzz-out fas fa-check' style='font-size: 20px; color: green; margin-right: 10px;'></i></a>";
                                                                echo "<a href='pembabtisananak_delete.php?id=" . $row["id"] . "' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\");' title='Hapus'><i class='fa fa-trash' style='font-size: 20px; color: red;'></i></a>";
                                                                echo "</td>";
                                                                echo "</tr>";
                                                            }
                                                        }
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo "<td>" . $row["nomorkk"] . "</td>";
                                                                echo "<td>";
                                                                echo "<a href='siswasidi_view.php?id=" . $row["id"] . "' title='Lihat'><i class='fa fa-eye' style='font-size: 20px; color: #2772ab; margin-right: 10px;'></i></a>";
                                                                echo "<a href='siswasidi_verifikasi.php?id=" . $row["id"] . "' onclick='return confirm(\"Apakah Anda yakin ingin Verifikasi?\");' title='Verifikasi'><i class='hvr-buzz-out fas fa-check' style='font-size: 20px; color: green; margin-right: 10px;'></i></a>";
                                                                echo "<a href='siswasidi_delete.php?id=" . $row["id"] . "' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\");' title='Hapus'><i class='fa fa-trash' style='font-size: 20px; color: red;'></i></a>";
                                                                echo "</td>";
                                                                echo "</tr>";
                                                            }
                                                        }
