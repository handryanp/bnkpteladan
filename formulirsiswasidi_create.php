...
<head>
  <meta charset="utf-8">
  <title>Formulir Siswa Sekolah SIDI</title>
...
<body>
  ...
  <div class="container">
    <div class="d-flex flex-column p-4 border">
      <h2 class="text-center mb-3 mt-3">Formulir Siswa Sekolah SIDI</h2>
      <?php
      session_start();
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group mb-3">
              ...
              <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" maxlength="10" required>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="TanggalLahir"> Tanggal Lahir</label>
              <input type="date" name="tanggal_lahir" class="form-control" placeholder="Tanggal Lahir" value="<?php echo date('y-m-d'); ?>" required>
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group mb-3">
          ...
          <div class="form-group mb-3">
            ...
            <textarea type="text" class="form-control" placeholder="Alamat" rows="3" name="alamat" maxlength="100" required></textarea>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
