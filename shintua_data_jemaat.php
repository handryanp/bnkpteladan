...
<div>
    ...
    <div class="container-fluid py-6 px-5">
        <div class="row g-5">
            <h2 class="m-0 text-secondary" style="position: relative;">Data Jemaat</h2>
            <div class="card-body">
                <?php
                session_start();
                            ...
                            <div class="col-sm-12">
                                ...
                                <table id="dataTable" class="table display table-bordered table-striped table-hover basic dataTable no-footer" role="grid">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT id, nomorkk, nama FROM kkjemaat_verifikasi";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>";
                                                echo "<a href='#" . $row["id"] . "' title='Edit'><i class='fas fa-pencil-alt' style='font-size: 20px; color: green; margin-right: 10px;'></i></a>";
                                                echo "<a href='formulirkkjemaat_verifikasi_view.php?id=" . $row["id"] . "' title='Lihat'><i class='fa fa-eye' style='font-size: 20px; color: #2772ab; margin-right: 10px;'></i></a>";
                                        ...
                                        $sql = "SELECT * FROM babtisanak_verifikasi";
                                        $result = $conn->query($sql);
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>";
                                                echo "<a href='#" . $row["id"] . "' title='Edit'><i class='fas fa-pencil-alt' style='font-size: 20px; color: green; margin-right: 10px;'></i></a>";
                                                echo "<a href='formulirpembabtisananak_verifikasi_view.php?id=" . $row["id"] . "';' title='Lihat'><i class='fas fa-eye' style='font-size: 20px; color: #2772ab; margin-right: 10px;'></i></a>";
                                        ...
                                        $sql = "SELECT * FROM sekolahsidi_verifikasi";
                                        $result = $conn->query($sql);
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>";
                                                echo "<a href='#" . $row["id"] . "' title='Edit'><i class='fas fa-pencil-alt' style='font-size: 20px; color: green; margin-right: 10px;'></i></a>";
                                                echo "<a href='formulirsiswasidi_verifikasi_view.php?id=" . $row["id"] . "';' title='Lihat'><i class='fas fa-eye' style='font-size: 20px; color: #2772ab; margin-right: 10px;'></i></a>";
